...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white shadow-lg py-3 relative z-50">
      <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <h1 className="text-3xl font-bold text-blue-600 hover:text-blue-700 transition-colors duration-200">
            <Link to="/" className="focus:outline-none">auto.uz</Link>
          </h1>
        </div>
      ...
      <div
        className={`fixed top-0 left-0 h-full w-[300px] bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-50 ${
